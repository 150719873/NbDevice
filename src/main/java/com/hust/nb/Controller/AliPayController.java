...
public class AliPayController {
    ...
    @ResponseBody
    @PostMapping("/aliPay")
    public String barCodePay(@RequestBody  String msg){
        ...
        product.setPayTime(GetDate.getCurrentDay());
        product.setPayType(1);
        String userNo = jsonObject.getString("userNo");
        product.setUsrNo(userNo);
        String userTel = jsonObject.getString("userTel");
        product.setUsrTel(userTel);
